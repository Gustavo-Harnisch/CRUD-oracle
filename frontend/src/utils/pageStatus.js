...
const STATUS_RULES = [
  ...
  { match: (path) => path.startsWith("/employee"), status: PAGE_STATUS.DEMO },
  { match: (path) => path.startsWith("/admin/employees"), status: PAGE_STATUS.DEMO },
  { match: (path) => path.startsWith("/admin/departments"), status: PAGE_STATUS.DEMO },
