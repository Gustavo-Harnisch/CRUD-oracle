...
const STATUS_RULES = [
  ...
  { match: (path) => path.startsWith("/customer/profile"), status: PAGE_STATUS.EDITING },
  { match: (path) => path.startsWith("/customer"), status: PAGE_STATUS.LIVE },
  { match: (path) => path.startsWith("/employee"), status: PAGE_STATUS.EDITING },
  { match: (path) => path.startsWith("/admin/employees"), status: PAGE_STATUS.EDITING },
  { match: (path) => path.startsWith("/admin/departments"), status: PAGE_STATUS.EDITING },
  { match: (path) => path.startsWith("/admin/audit"), status: PAGE_STATUS.EDITING },
  { match: (path) => path.startsWith("/admin/rates"), status: PAGE_STATUS.EDITING },
  { match: (path) => path.startsWith("/admin/requests"), status: PAGE_STATUS.EDITING },
  ...
  { match: (path) => path.startsWith("/contact"), status: PAGE_STATUS.EDITING },
