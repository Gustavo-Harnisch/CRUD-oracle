...
CREATE TABLE JRGY_DEPARTAMENTO (
    ...
    CONSTRAINT FK_JRGY_DEP_JEFE FOREIGN KEY (JEFE_EMPLEADO_ID) REFERENCES JRGY_EMPLEADO (COD_EMPLEADO)
);
/
...
BEGIN
    OPEN CUR FOR
        ...
        GROUP BY d.COD_DEPARTAMENTO, d.NOMBRE, d.JEFE_EMPLEADO_ID, e.RUT, d.PRESUPUESTO;
END;
/
...
BEGIN
    ...
    VALUES (P_NOMBRE, P_AP1, P_AP2, P_TEL, P_EMAIL, P_PASS_HASH, V_ESTADO_ACTIVO)
    RETURNING COD_USUARIO INTO P_ID;
...
BEGIN
    ...
    BEGIN
        ...
        WHERE NOT EXISTS (SELECT 1 FROM JRGY_CAT_ESTADO_LABORAL WHERE UPPER(ESTADO_LABORAL) = 'INACTIVO');
    END;
    BEGIN
        INSERT INTO JRGY_CAT_ESTADO_LABORAL (COD_ESTADO_LABORAL, ESTADO_LABORAL)
        SELECT 3, 'DESPEDIDO' FROM dual
        WHERE NOT EXISTS (SELECT 1 FROM JRGY_CAT_ESTADO_LABORAL WHERE UPPER(ESTADO_LABORAL) = 'DESPEDIDO');
    END;
    BEGIN
        INSERT INTO JRGY_CAT_ESTADO_LABORAL (COD_ESTADO_LABORAL, ESTADO_LABORAL)
        SELECT 4, 'RENUNCIADO' FROM dual
        WHERE NOT EXISTS (SELECT 1 FROM JRGY_CAT_ESTADO_LABORAL WHERE UPPER(ESTADO_LABORAL) = 'RENUNCIADO');
    END;
