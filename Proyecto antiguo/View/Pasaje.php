...
?>
        ...
        <body>
            ...
            <main>
                ...
                <form id="formularioPasaje" action="horarios.php" method="GET">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                origenSelect.addEventListener('change', function() {
                    ...
                    Array.from(destinoSelect.options).forEach(option => {
                        option.disabled = option.value === selectedOrigen;
                    });
                });
                ...
                destinoSelect.addEventListener('change', function() {
                    ...
                    Array.from(origenSelect.options).forEach(option => {
                        option.disabled = option.value === selectedDestino;
                    });
                });

    document.getElementById('buscarPasajeForm').addEventListener('submit', function(event) {
        ...
        fetch('get_horarios.php', {
            ...
            body: JSON.stringify({ origen, destino, fecha_viaje: fechaViaje })
        })
        .then(response => response.json())
        .then(data => {
            ...
            if (data.length > 0) {
                ...
                data.forEach(horario => {
                    ...
                    li.textContent = `ID Horario: ${horario.ID_HORARIO}`;
                    ul.appendChild(li);
                });
                horariosDiv.appendChild(ul);
            } else {
                horariosDiv.textContent = 'No hay horarios disponibles para esta ruta y fecha.';
            }
        })
        .catch(error => console.error('Error:', error));
    });
