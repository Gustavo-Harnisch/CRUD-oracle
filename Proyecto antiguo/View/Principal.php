...
<body>
    ...
    <div class="nav-links">
        ...
        <a href="indexReseña.php">Reseñas</a>
        <a href="incidentes.php">Reportar Incidente</a>
    </div>
    <div class="nav-right">
        <?php if (isset($_SESSION['cliente'])): ?>
            <span style="color: white;">Bienvenido Cliente
            <a href="logout.php" class="btn-entrar">Cerrar Sesión</a>
        <?php else: ?>
            <a href="Login.php" class="btn-entrar">Iniciar Sesión</a>
        <?php endif; ?>
    </div>
</nav>
    ...
    <header id="inicio">
        <div class="content">
            ...
            <a href="pasaje.php" class="btn">Buscar Pasajes</a>
        </div>
    </header>
        ...
        <section id="proyectos">
            ...
            <div class="card-container">
                ...
                <div class="card">
                    ...
                    <p>Nuevos destinos en el norte, sur y centro de Chile.</p>
                </div>
                <div class="card">
                    <h3>Digitalización</h3>
                    <p>Compra de pasajes mediante app móvil.</p>
                </div>
            </div>
        </section>
