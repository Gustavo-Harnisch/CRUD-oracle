<?php
require_once '../Models/MRegister.php'; // Ajusta la ruta según la ubicación de MRegister.php
require_once '../Models/ConexionBase.php'; // Ajusta la ruta según la ubicación de ConexionBase.
